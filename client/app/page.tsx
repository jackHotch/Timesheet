...
export default function Page() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="absolute top-0 right-0 flex h-full w-[55%] flex-col items-center justify-center gap-6 text-center">
      ...
      <div className="relative z-10 flex h-full w-1/2 flex-col justify-between rounded-r-4xl bg-background p-10 shadow-2xl">
        ...
        <div className="mx-auto w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && <p className="text-sm text-destructive">Invalid email or password. Please try again.</p>}
